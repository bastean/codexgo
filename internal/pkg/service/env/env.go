...
const (
	...
	DATABASE_BADGERDB_DSN = "CODEXGO_DATABASE_BADGERDB_DSN"

	SMTP_HOST     = "CODEXGO_SMTP_HOST"
	SMTP_PORT     = "CODEXGO_SMTP_PORT"
	SMTP_USERNAME = "CODEXGO_SMTP_USERNAME"
	SMTP_PASSWORD = "CODEXGO_SMTP_PASSWORD" //nolint:gosec

	JWT_SECRET_KEY = "CODEXGO_JWT_SECRET_KEY" //nolint:gosec
	...
	SERVER_GIN_COOKIE_SECRET_KEY   = "CODEXGO_SERVER_GIN_COOKIE_SECRET_KEY" //nolint:gosec
