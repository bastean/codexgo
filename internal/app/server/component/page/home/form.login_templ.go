...
func LoginFormInit(formTagID string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_LoginFormInit_ebbb`,
		Function: `function __templ_LoginFormInit_ebbb(formTagID){$(` + "`" + `#${formTagID}` + "`" + `)
        .form({
            ...Form.Settings,
            fields: {
                Login: {
    ...
    ;
		...
		Call:       templ.SafeScript(`__templ_LoginFormInit_ebbb`, formTagID),
		CallInline: templ.SafeScriptInline(`__templ_LoginFormInit_ebbb`, formTagID),
	}
}
...
func LoginForm() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/server/component/page/home/form.login.templ`, Line: 53, Col: 26}
		}
